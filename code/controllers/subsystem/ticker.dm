...
/datum/controller/subsystem/ticker/proc/send_news_report()
	...
	if(SSblackbox.first_death)
		...
		var/list/investigator = list("Eastwood Investigators","A band of couriers","Patrolling rangers","A few mysterious strangers","The NCR","The Legion","The Brotherhood","The Den")
		if(ded.len)
