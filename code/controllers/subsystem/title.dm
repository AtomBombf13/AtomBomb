...
/datum/controller/subsystem/title/Initialize()
	...
	var/list/provisional_title_screens = flist("interface/title_screens/")
	...
	if(length(title_screens))
		file_path = "interface/title_screens/[pick(title_screens)]" //[global.config.directory]/title_screens/images
