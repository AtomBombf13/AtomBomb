...
/obj/item/stock_parts/capacitor
	name = "capacitor"
	desc = "A pre-war design for a simple consumer-grade capacitor. Not much better than a watch battery. (stock part)"
	icon_state = "capacitor"
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=50)

/obj/item/stock_parts/scanning_module
	name = "scanning module"
	desc = "A pre-war design for a simple consumer-grade scanning device. Not much better than a light sensitive circuit. (stock part)"
	icon_state = "scan_module"
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=20)

/obj/item/stock_parts/manipulator
	name = "manipulator"
	desc = "A pre-war design for a simple consumer-grade manipulator. Not much better than a simple gear. (stock part)"
	icon_state = "micro_mani"
	custom_materials = list(/datum/material/iron=30)

/obj/item/stock_parts/micro_laser
	name = "laser"
	desc = "A pre-war design for a simple consumer-grade laser. Not much better than a nixie tube. (stock part)"
	icon_state = "micro_laser"
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin
	name = "matter bin"
	desc = "A pre-war design for a simple consumer-grade storage bin. Not much better than a funnel. (stock part)"
...
/obj/item/stock_parts/capacitor/simple
	name = "watch battery"
	desc = "A small battery presumably used to keep a watch timing properly. Could be useful as a makeshift capacitor. (stock part)"
	icon_state = "watch_battery"
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=50)

/obj/item/stock_parts/scanning_module/simple
	name = "light sensitive circuit"
	desc = "Sometimes found in cameras or infrared detectors. Useful for scanning things, if a little low-tech. (stock part)"
	icon_state = "light_sensitive_circuit"
	custom_materials = list(/datum/material/iron=50, /datum/material/glass=20)

/obj/item/stock_parts/manipulator/simple
	name = "simple gear"
	desc = "A simple gear. A couple of these could probably be used in a mechanism to manipulate things. (stock part)"
	icon_state = "simple_gear"
	custom_materials = list(/datum/material/iron=30)

/obj/item/stock_parts/micro_laser/simple
	name = "nixie tube"
	desc = "A small bulb with a complicated filament pattern. Puts off enough heat that it could be used for heating small components in a pinch. (stock part)"
	icon_state = "simple_bulb"
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin/simple
	name = "intake funnel"
	desc = "Practically a metal cone. Useful to store some stuff in a machine, at least. (stock part)"
	icon_state = "funnel"
	custom_materials = list(/datum/material/iron=80)
...
/obj/item/stock_parts/capacitor/adv
	name = "capacitor"
	desc = "A fairly modern design for a capacitor, it can take in and distribute power pretty quickly compared to a battery. (stock part)"
...
/obj/item/stock_parts/scanning_module/adv
	name = "small antenna"
	desc = "Useful for scanning and analyzing signals. Comes with a built in miniature light sensor, too! (stock part)"
...
/obj/item/stock_parts/manipulator/nano
	...
	desc = "More than a few gears interlocked together, useful for manipulating things on a finer scale. (stock part)"
...
/obj/item/stock_parts/micro_laser/high
	name = "flash bulb"
	desc = "A reusable flash bulb. Not only does it shine particularly bright, it can let out a fair bit of heat. (stock part)"
...
/obj/item/stock_parts/matter_bin/adv
	name = "hopper"
	desc = "A spacious hopper for containing just about anything in a machine and distributing it effectively. (stock part)"
	icon_state = "hopper"
	rating = 2
	custom_materials = list(/datum/material/iron=80)
...
/obj/item/stock_parts/capacitor/super
	...
	desc = "A very effective capacitor, with a bit more heft to it. (stock part)"
...
/obj/item/stock_parts/scanning_module/phasic
	...
	desc = "A high-resolution antenna and camera device, this could scan a pretty wide variety of things. (stock part)"
...
/obj/item/stock_parts/manipulator/pico
	...
	desc = "A whole lot of finely crafted gears, belts, and gearshafts. This could probably manipulate things with microscopic precision. (stock part)"
...
/obj/item/stock_parts/micro_laser/ultra
	name = "laser diode"
	icon_state = "diode"
	desc = "A laser diode able to put out heat and light very precisely. (stock part)"
	rating = 3
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin/super
	name = "storage bin"
	desc = "A small container designed compressed and store just about anything safely in a machine. (stock part)"
...
/obj/item/stock_parts/capacitor/quadratic
	...
	desc = "This absurdly efficient capacitor was made with pre-war materials and designs. (stock part)"
...
/obj/item/stock_parts/scanning_module/triphasic
	...
	desc = "A compact, ultra-high resolution scanning device made with pre-war materials and designs. (stock part)"
...
/obj/item/stock_parts/manipulator/femto
	name = "pre-war servo"
	desc = "A microservo capable of manipulating things on the atomic scale, made using pre-war materials and designs. (stock part)"
...
/obj/item/stock_parts/micro_laser/quadultra
	...
	desc = "This extremely powerful micro-laser could only be made with pre-war materials and designs. (stock part)"
	rating = 4
	custom_materials = list(/datum/material/iron=10, /datum/material/glass=20)

/obj/item/stock_parts/matter_bin/bluespace
	name = "pre-war storage system"
	desc = "A container that uses the same pre-war tech that some Vaults pack into Pip-Boys to contain large amounts of material. (stock part)"
