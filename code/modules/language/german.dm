/datum/language/german
	name = "German"
	desc = "The language used by members of the rustwalker tribe."
	key = "g"
	icon_state = "ratvar"
	syllables = list("Frau", "Mann", "Waffe", "Schiff", "beziehungsweise", "dazwischen", "grenze", "Strasse", "Halle", "Bezeichnung", "und", "von", "Kind", "Arzt", 
					 ...
					 "Unterhaltung", "Platituede", "Pferd", "Poker", "spielen", "Radio", "Baum", "Raumschlacht", "Kolonie", "kolonisieren", 
 					 ...
 					 "Schmerzen", "gebrochen", "brechen", "alle", "Musik", "also", "Interesse", "Pruegel", "Alkohol", "Getraenk", "Sankt",
 					 "dynamisch", "dynamik", "Organisation", "hauptsache", "Radio", "ueberhaupt", "weil", "denn", "deshalb", "mir", "dir", 
 					 "dein", "mein", "ihr", "eure", "seine", "meine", "Granate", "Katze", "Hund", "Fisch", "Ziege", "evangelisch", "gestorben",
					 "amtlich", "ausgabe", "Dienstag", "Donnerstag", "Mittwoch", "Freitag", "Nummer", "katholisch", "geschieden")
