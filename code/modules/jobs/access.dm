...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(2) //security
			return list(ACCESS_SEC_DOORS, ACCESS_SECURITY, ACCESS_BRIG, ACCESS_FORENSICS_LOCKERS, ACCESS_HOS, ACCESS_LEGION, ACCESS_NCR, ACCESS_NCR_ARMORY, ACCESS_BOS, ACCESS_ENCLAVE,	ACCESS_KHAN)
		if(3) //medbay
