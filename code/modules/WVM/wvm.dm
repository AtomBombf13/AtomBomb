...
/obj/machinery/mineral/wasteland_vendor/medical
	...
	prize_list = list(
		...
		new /datum/data/wasteland_equipment("Stimpak",						/obj/item/reagent_containers/hypospray/medipen/stimpak,				75),
		new /datum/data/wasteland_equipment("Super Stimpak",				/obj/item/reagent_containers/hypospray/medipen/stimpak/super,		200),
