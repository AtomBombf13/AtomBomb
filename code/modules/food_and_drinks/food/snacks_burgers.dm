...
/obj/item/reagent_containers/food/snacks/burger/red
	...
	color = "#DA0000FF"
	bonus_reagents = list(
		/datum/reagent/colorful_reagent/crayonpowder/red = 10,
		/datum/reagent/consumable/nutriment/vitamin = 5
	)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/burger/orange
	...
	color = "#FF9300FF"
	bonus_reagents = list(
		/datum/reagent/colorful_reagent/crayonpowder/orange = 10,
		/datum/reagent/consumable/nutriment/vitamin = 5
	)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/burger/yellow
	...
	color = "#FFF200FF"
	bonus_reagents = list(
		/datum/reagent/colorful_reagent/crayonpowder/yellow = 10,
		/datum/reagent/consumable/nutriment/vitamin = 5
	)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/burger/green
	...
	color = "#A8E61DFF"
	bonus_reagents = list(
		/datum/reagent/colorful_reagent/crayonpowder/green = 10,
		/datum/reagent/consumable/nutriment/vitamin = 5
	)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/burger/blue
	...
	color = "#00B7EFFF"
	bonus_reagents = list(
		/datum/reagent/colorful_reagent/crayonpowder/blue = 10,
		/datum/reagent/consumable/nutriment/vitamin = 5
	)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/burger/purple
	...
	color = "#DA00FFFF"
	bonus_reagents = list(
		/datum/reagent/colorful_reagent/crayonpowder/purple = 10,
		/datum/reagent/consumable/nutriment/vitamin = 5
	)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/burger/black
	...
	color = "#1C1C1C"
	bonus_reagents = list(
		/datum/reagent/colorful_reagent/crayonpowder/black = 10,
		/datum/reagent/consumable/nutriment/vitamin = 5
	)
	foodtype = GRAIN | MEAT
...
/obj/item/reagent_containers/food/snacks/burger/white
	...
	color = "#FFFFFF"
	bonus_reagents = list(
		/datum/reagent/colorful_reagent/crayonpowder/white = 10,
		/datum/reagent/consumable/nutriment/vitamin = 5
	)
	foodtype = GRAIN | MEAT
