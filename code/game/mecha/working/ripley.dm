...
/obj/vehicle/sealed/mecha/working/ripley/go_out()
	..()
	update_icon()
...
/obj/vehicle/sealed/mecha/working/ripley/deathripley // Admin-only mecha.
...
/obj/vehicle/sealed/mecha/working/clarke/go_out()
