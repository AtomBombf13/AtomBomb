...
/// Firefighter
#define EXOSUIT_MODULE_CLARKE		(1<<3)
...
#define EXOSUIT_MODULE_GYGAX_MED	(1<<6)
/// Module is compatible with Phazon Exosuit models
#define EXOSUIT_MODULE_PHAZON		(1<<7)
/// Marauder
#define EXOSUIT_MODULE_MARAUDER		(1<<8)

/// Module is compatible with "Working" Exosuit models - Ripley and Clarke
#define EXOSUIT_MODULE_WORKING		EXOSUIT_MODULE_RIPLEY | EXOSUIT_MODULE_FIREFIGHTER | EXOSUIT_MODULE_CLARKE
/// Module is compatible with "Combat" Exosuit models - Gygax, H.O.N.K, Durand, Marauder and Phazon
#define EXOSUIT_MODULE_COMBAT		EXOSUIT_MODULE_GYGAX | EXOSUIT_MODULE_DURAND | EXOSUIT_MODULE_PHAZON | EXOSUIT_MODULE_MARAUDER
