...
#define LOG_TERMINAL (1 << 18)
#define LOG_MECHA (1 << 19)
...
#define INDIVIDUAL_IC_LOG			(LOG_SAY | LOG_WHISPER | LOG_EMOTE | LOG_SUBTLE | LOG_PDA | LOG_CHAT | LOG_COMMENT | LOG_TELECOMMS | LOG_TERMINAL)
#define INDIVIDUAL_OOC_LOG			(LOG_OOC | LOG_ADMIN)
#define INDIVIDUAL_OWNERSHIP_LOG	(LOG_OWNERSHIP)
#define INDIVIDUAL_SHOW_ALL_LOG		(LOG_ATTACK | LOG_SAY | LOG_WHISPER | LOG_EMOTE | LOG_SUBTLE | LOG_DSAY | LOG_PDA | LOG_CHAT | LOG_COMMENT | LOG_TELECOMMS | LOG_OOC | LOG_ADMIN | LOG_OWNERSHIP | LOG_GAME)
