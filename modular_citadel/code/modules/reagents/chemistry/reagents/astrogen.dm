...
/datum/reagent/fermi/astral/on_mob_delete(mob/living/carbon/M)
	...
	if(M.mind) //Just in case someone else is inside of you, it makes them a ghost and should hopefully bring them home at the end.
		...
		to_chat(G2, "<span class='warning'>[M]'s consciousness snaps back to them as [M.p_their()] astrogen runs out, kicking your projected mind out!'</b></span>")
...
/datum/reagent/fermi/astral/addiction_act_stage1(mob/living/carbon/M)
	...
	switch(antiGenetics)
		...
		if(-INFINITY to 30)
			...
			deadchat_broadcast(span_warning("[M] has become one with the universe, meaning that their IC consciousness is continuous in a new life. If they find a way back to life, they are allowed to remember their previous life. Be careful what you say. If they abuse this, bwoink the FUCK outta them."))
